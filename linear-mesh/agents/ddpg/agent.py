...
class Agent:
    ...
    def save(self):
        torch.save(self.actor_local.state_dict(), "models/ddpg_actor_theo_convergence_25stas_15eps_state_modif.torch")
        torch.save(self.critic_local.state_dict(), "models/ddpg_critic_theo_convergence_25stas_15eps_state_modif.torch")

    def load(self):
        self.actor_local.load_state_dict(torch.load("models/ddpg_actor_theo_convergence_25stas_15eps_state_modif.torch"))
        self.critic_local.load_state_dict(torch.load("models/ddpg_critic_theo_convergence_25stas_15eps_state_modif.torch"))
